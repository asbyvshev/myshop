...
-- --  KEY `fk_product_images_id_mage_idx` (`id_image`),
-- --  CONSTRAINT `fk_product_images_id_mage` FOREIGN KEY (`id_image`) REFERENCES `image` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
-- --  CONSTRAINT `fk_product_images_id_product` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
-- -- ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
